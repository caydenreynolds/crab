...
//
// ///
// /// Serde Serializer implementation used to mangle struct ids
// ///
// struct Mangler {
//     output: String,
// }
//
// pub fn mangle(value: &T) -> Result<String> where T: Serialize {
//     let mut mangler = Mangler {
//         output: String::new()
//     };
//     value.serialize(&mut mangler);
//     Ok(mangler.output)
// }
//
// impl <'a> ser::Serializer for &'a mut Mangler {
//     type Ok = ();
//     type Error = MangleError;
